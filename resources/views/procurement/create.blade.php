...
@section('title', 'New Procurement - DARTS')
@section('page-title', 'New Procurement Record')

@section('content')
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form action="{{ route('procurement.store') }}" method="POST" x-data="procurementForm()">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div>
                    ...
                    <input type="text" name="sales_type" id="sales_type" value="{{ old('sales_type') }}"
            ...
            <div class="mb-6">
                ...
                <textarea name="item_description" id="item_description" rows="2" required
                          class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 @error('item_description') border-red-500 @enderror">{{ old('item_description') }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                <div>
                    ...
                    <input type="number" name="quantity" id="quantity" value="{{ old('quantity', 1) }}" required min="1" x-model="quantity"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" name="unit_price" id="unit_price" value="{{ old('unit_price') }}" required min="0" x-model="unitPrice"
            ...
            <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-200">
                ...
                <button type="submit" class="px-6 py-2 bg-emerald-600 text-white text-sm font-medium rounded-lg hover:bg-emerald-700 transition">
                    <i class="fa-solid fa-save mr-2"></i> Save Procurement
                </button>
            </div>
        </form>
    </div>
