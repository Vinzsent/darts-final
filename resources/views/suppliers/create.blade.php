...
@section('title', 'Create Supplier - DARTS')
        ...
        <form method="POST" action="{{ route('suppliers.store') }}" class="p-6 space-y-6">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="payment_terms" name="payment_terms" value="{{ old('payment_terms') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
            ...
            <div class="pt-4 border-t border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="fax_number" name="fax_number" value="{{ old('fax_number') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
            ...
            <div class="flex items-center justify-end space-x-3 pt-4 border-t border-gray-200">
                ...
                <button type="submit" class="px-4 py-2 text-sm font-medium text-white bg-emerald-600 rounded-lg hover:bg-emerald-700 transition">
                    <i class="fa-solid fa-save mr-2"></i> Create Supplier
                </button>
            </div>
        </form>
    </div>
